...
top to bottom is 23.
[Provided by resources/18_short_input.txt]

That is, 3 + 7 + 4 + 9 = 23.

Find the maximum total from top to bottom in triangle.txt [Provided by resources/67_triangle.txt], a 15K text file
...
# The solution to this question is the same as that provided in 18.
